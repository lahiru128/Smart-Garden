...
import com.example.smartgarden.adapters.AdapterComments;
import com.example.smartgarden.R;
import com.example.smartgarden.models.ModelComment;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private Uri saveImageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            stream.flush();
            stream.close();
            uri = FileProvider.getUriForFile(this, "com.blogspot.smartgarden.firebaseapp.fileprovider", file);
        }
        catch (Exception e){
